...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.twotteur.TwotteurApplicationTests", () -> new AotSpringBootConfigContextLoader(TwotteurApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.twotteur.TwotteurApplicationTests", TwotteurApplicationTestsContextInitializer.class);
    return entries;
  }
}
